    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      >
        ...
        <div style={{ paddingTop: '5rem', paddingBottom: '5rem' }}>
          ...
          >
            ...
            >
              Enter your GATE score or JEE rank — get an instant ranked list of colleges you can
              realistically target, sorted by admission probability.
            </p>
            ...
            >
              <Link
                ...
                style={{
                  ...
                  fontWeight: 700,
                  border: 'none',
                  boxShadow: '0 4px 18px -6px rgba(255,255,255,.15)',
                }}
              >
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <h2 style={{ fontSize: 'clamp(1.7rem,4vw,2.6rem)' }}>
              Built on real <span className="gradient-text">counselling rules</span>
            </h2>
            <p style={{ marginTop: '0.7rem', color: 'var(--text-muted)', fontSize: '1.05rem' }}>
            ...
            {[
              {
                ...
                d: 'Data sourced directly from JoSAA, CSAB, COAP and CCMT portals — not third-party scrapers.',
              },
              {
                icon: '⚖️',
                t: 'Counselling-accurate rules',
                d: 'GATE is score-based; JEE maps ranks to IITs/NITs/IIITs with home-state quota, gender pool and reserved category applied exactly.',
              },
              {
                icon: '📊',
                t: 'Last-round cutoffs',
                d: "We use each programme's final-round closing cutoff — the most realistic threshold for 'will I actually get a seat'.",
              },
              {
                icon: '🔒',
                t: 'Honest predictions',
                d: 'We never claim a fake accuracy number. Predictions are indicative — actual allotment depends on seat matrix and choice-filling.',
              },
              {
                icon: '⚡',
                t: 'Instant results',
                d: 'No account. No waiting. Enter your details and see your matches within seconds — preview free, unlock for ₹49.',
              },
              {
                icon: '📥',
                t: 'PDF download',
                d: 'Get a formatted PDF of your complete college list to share with parents, mentors or for offline reference during counselling.',
              },
            ].map(x => (
              <div
                key={x.t}
                className="glass glass-hover"
                style={{ padding: '1.6rem', borderRadius: 'var(--r)' }}
              >
                <div
                  style={{
                    width: 42,
          ...
          <div className="grid-4">
            {[
              ...
              <div
                key={x.n}
                className="glass"
                style={{ padding: '1.6rem', borderRadius: 'var(--r)', position: 'relative' }}
              >
                <div
                  style={{
                    fontFamily: 'Satoshi,Inter,sans-serif',
                ...
                <h4 style={{ fontWeight: 700, fontSize: '1rem', marginBottom: '0.45rem' }}>
                  {x.t}
                </h4>
        ...
        <div className="container" style={{ maxWidth: 900 }}>
          <div style={{ textAlign: 'center', marginBottom: '2.8rem' }}>
            ...
            <p style={{ marginTop: '0.7rem', fontSize: '1.05rem' }}>
              ...
              <span className="emph" style={{ fontWeight: 700 }}>
          ...
          <div
            className="grid-2"
            style={{ alignItems: 'stretch', gap: '1.5rem', maxWidth: 780, margin: '0 auto' }}
          >
            {/* Free tier */}
            <div
              className="glass"
            ...
            >
              ...
              <p
                style={{ color: 'var(--text-muted)', fontSize: '0.82rem', marginBottom: '1.4rem' }}
              >
              ...
              >
                {[
                  ...
                  >
                    <span className="emph" style={{ flexShrink: 0, marginTop: '0.1rem' }}>
                      ✓
                    </span>
                    {f}
                  </li>
            ...
            <div className="card-dark" style={{ padding: '1.8rem' }}>
              ...
              >
                ₹49{' '}
                <span style={{ fontSize: '0.85rem', fontWeight: 500 }} className="muted-d">
                  one-time
                </span>
              </div>
              <p
                className="muted-d"
                style={{ fontSize: '0.82rem', marginBottom: '1.4rem', lineHeight: 1.5 }}
              >
              ...
              <div
                className="muted-d"
                style={{ marginTop: '0.7rem', fontSize: '0.7rem', textAlign: 'center' }}
              >
      ...
      <footer style={{ background: '#0a0a09', color: '#f5f3ef', paddingTop: '3rem' }}>
        <div className="container">
          ...
          <div className="footer-columns" style={{ marginBottom: '1.5rem' }}>
            <div style={{ maxWidth: 380 }}>
              ...
              <p style={{ color: '#a8a5a0', fontSize: '0.83rem', lineHeight: 1.65 }}>
                An independent prediction tool. Not affiliated with JoSAA, CSAB, IIT, NIT, the
                GATE/JEE authorities or any institute.
              </p>
            </div>
            ...
            <div style={{ fontSize: '0.82rem', lineHeight: 2, color: '#a8a5a0' }}>
              ...
              <div>
                <Link href="/admin" style={{ color: '#a8a5a0' }}>
                  Admin
                </Link>
              </div>
            </div>
          ...
          >
            © {new Date().getFullYear()} CollegeCompass. Predictions are indicative — always verify
        ...
        >
          <span
            style={{
              ...
              WebkitTextFillColor: 'transparent',
              background:
                'linear-gradient(180deg, rgba(255,255,255,0.8) 0%, rgba(255,255,255,0.1) 60%, transparent 100%)',
              WebkitBackgroundClip: 'text',
              backgroundClip: 'text',
              userSelect: 'none',
              whiteSpace: 'nowrap',
